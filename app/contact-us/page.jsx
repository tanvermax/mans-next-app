...
export const metadata = {
    title: 'Contact Us | Mans Packaging',
    description: 'Contact Us Mans Packaging, for your complete packeging solution.',
}
const Contact = () => {
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 grid-cols-1">
                        ...
                        <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                            <h2 className="text-[#25A6E2] font-manrope text-4xl font-semibold leading-10 mb-11">
                                Send Us A Message
                            </h2>
                            <input
                                type="text"
                            ...
                            <input
                                ...
                                placeholder="Message"
                            />
                            <button className="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-indigo-800 bg-[#25A6E2] shadow-sm">
                                Send
                            </button>
                        </div>
                    </div>
