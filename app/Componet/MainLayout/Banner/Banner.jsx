    ...
    <section aria-label="Featured Services Banner" className="w-full mx-auto relative animate-fade-in-smooth">
      <Swiper
        ...
        pagination={{
          ...
          bulletActiveClass: "swiper-pagination-bullet-active !opacity-100 !bg-[#25A6E2]",
            ...
            <div className="relative h-[400px] md:h-[500px] lg:h-[700px] w-full">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-4 md:p-8">
                <div className="text-center max-w-4xl mx-auto space-y-4 md:space-y-6">
                  <h1 className="text-xl md:text-4xl lg:text-6xl font-bold drop-shadow-lg animate-fade-in">
                    {slide.heading}
                  </h1>
                  ...
                  <div className="pt-4 animate-fade-in-more-delayed">
                    <a
                      href={slide.ctaLink || "#"}
                      className="inline-block bg-[#25A6E2] hover:bg-blue-700 text-white text-xs md:text-base font-semibold md:py-3 py-1 px-2 md:px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
